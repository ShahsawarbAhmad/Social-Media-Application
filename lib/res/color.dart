...
class AppColors {
  ...
  static const Color textFieldDefaultBorderColor = Color(0xfffdfdf1);

  static const Color textFieldFocusBorderColor = Color.fromRGBO(19, 103, 33, 1);

  static const Color primaryButtonCollor = Color(0xff242424);
  ...
  static const Color otpBackgroundColor = Color(0xffff5f5f);
